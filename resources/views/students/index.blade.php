		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sx-6">
                        <!-- Search form -->
                        <a href="{{ route('students.index')}}" class="btn btn-azul" ><i class="fa fa-refresh" aria-hidden="true"></i> <span>REFESCAR</span></a>
						<a href="{{ route('students.create')}}" class="btn btn-verde" ><i class="fa fa-plus-circle" aria-hidden="true"></i> <span>NUEVO ESTUDIANTE</span></a>
                        ...
                        <a href="{{ route('students.create')}}" class="btn btn-azul" data-toggle="modal"><i class="fa fa-download" aria-hidden="true"></i> <span>EXPORTAR</span></a>
					</div>
				</div>
			</div>
				...
				<tbody>
					<tr>
						...
						<td>
                             ...
                             <a class="pencil" href="{{route('students.edit',$student)}}"><i  style="color:#e0cc18;" class="fa fa-pencil" aria-hidden="true"></i></a>
