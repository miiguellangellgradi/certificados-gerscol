    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4">
                        <h2 class="table-head-title">Manage <b>Certificates</b></h2>
                    </div>
                    ...
                    <form action="{{ route('certificate.index') }}" method="GET">
                        <div class="form-row">
                            ...
                            <div class="col">
                                <input name="BusquedaCedula" class="form-search form-control" placeholder="Search by ID" type="search" id="search1" aria-label="Search">
                            </div>
                            <div class="col-auto">
            ...
            <div class="row mb-2">
                <div class="col">
                    <a href="{{ route('certificate.create') }}" class="btn btn-verde">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i> <span>New Certificate</span>
                    </a>
                    <a href="#deleteEmployeeModal" class="btn btn-azul" data-toggle="modal">
                        <i class="fa fa-upload" aria-hidden="true"></i> <span>Import</span>
                    </a>
                    <a href="#exportModal" class="btn btn-azul" data-toggle="modal">
                        <i class="fa fa-download" aria-hidden="true"></i> <span>Export</span>
                    </a>
                </div>
            </div>
